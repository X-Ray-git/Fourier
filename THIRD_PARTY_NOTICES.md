...
- Copyright: Folo contributors
- License text: [`LICENSE`](LICENSE)

## PiliPlus

- Source: https://github.com/bggRGjQaUbCoE/PiliPlus
- License: GNU General Public License v3.0
- Copyright: PiliPlus contributors
- License text: [`third_party/licenses/GPL-3.0.txt`](third_party/licenses/GPL-3.0.txt)
...
- License: MIT License
- Copyright (c) 2020 Nell
- License text: [`third_party/licenses/MIT-interactiveviewer_gallery.txt`](third_party/licenses/MIT-interactiveviewer_gallery.txt)

## liquid_glass_widgets

- Source: https://github.com/sdegenaar/liquid_glass_widgets
- License: MIT License
- Copyright (c) 2024 Sebastian Degenaar
- License text: [`third_party/licenses/MIT-liquid_glass_widgets.txt`](third_party/licenses/MIT-liquid_glass_widgets.txt)
...
- License text: [`third_party/licenses/MIT-liquid_glass_renderer.txt`](third_party/licenses/MIT-liquid_glass_renderer.txt)
...
- License text: [`third_party/licenses/MIT-youtubei-js.txt`](third_party/licenses/MIT-youtubei-js.txt)

## googlevideo

- Version: 4.0.4
- Source: https://github.com/LuanRT/googlevideo
- License: MIT License
- Copyright (c) 2024 LuanRT
- License text: [`third_party/licenses/MIT-googlevideo.txt`](third_party/licenses/MIT-googlevideo.txt)
...
- License: MIT License
- Copyright (c) 2024 LuanRT
- License text: [`third_party/licenses/MIT-bgutils-js.txt`](third_party/licenses/MIT-bgutils-js.txt)
...
- Copyright: Shaka Player authors
- License text: [`third_party/licenses/Apache-2.0.txt`](third_party/licenses/Apache-2.0.txt)
...
- Copyright 2021-2025 Buf Technologies, Inc.; varint implementation copyright
  2008 Google Inc.
- License texts:
  [`third_party/licenses/Apache-2.0.txt`](third_party/licenses/Apache-2.0.txt),
  [`third_party/licenses/BSD-3-Clause-protobuf-varint.txt`](third_party/licenses/BSD-3-Clause-protobuf-varint.txt)
...
- License text: [`third_party/licenses/MIT-fflate.txt`](third_party/licenses/MIT-fflate.txt)
...
- Usage: Fourier Wiki 页面的客户端 Markdown 渲染；UMD 构建内置在
...
- Usage: Fourier Wiki 页面的标题锚点生成；UMD 构建内置在
