...
class GlassEffect extends StatefulWidget {
  ...
  static Future<void> preWarm() async {
    ...
    _isPreparing = true;
    const path = 'shaders/liquid_glass/interactive_indicator.frag';
    const testPath = 'shaders/liquid_glass/interactive_indicator.frag';
    try {
  ...
  void paint(PaintingContext context, Offset offset) {
    if (child != null) {
      ...
      if (blurSigma > 0) {
        ...
        filter = ui.ImageFilter.compose(outer: brightnessFilter, inner: filter);
