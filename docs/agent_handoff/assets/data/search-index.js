...
window.WIKI_SEARCH_MANIFEST = "692f7638398dbb1f";
window.WIKI_SEARCH_INDEX = [
 ...
 },
 {
  ...
  "text": "Auto Folo — 高密度信息流阅读客户端 Auto Folo · 基于 Folo API 与 DeepSeek 驱动 让 AI 替你 筛选信息洪流 Auto Folo 把 Folo 时间线 、 长文阅读 与 可配置的 AI 工作流 放进同一个客户端：后台翻译与摘要帮助快速浏览，垃圾拦截判定进入独立审核页， 最终保留或移除仍由你决定。 开始阅读 Wiki 查看当前状态 macOS Android 个人非官方客户端 AGPL-3.0 离线工程 Wiki 非官方个人二次开发客户端，不隶属于 Folo、RSSNext 或其运营方，也不代表官方发布版本。 核心能力 不止于阅读——从数据拉取到 AI 决策，形成完整的智能信息处理闭环。 <div class=\"feature-card\"> <div class=\"feature-icon\"> <svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" aria-hidden=\"true\"><path d=\"M8 6h13M8 12h13M8 18h13\"/><circle cx=\"3.5\" cy=\"6\" r=\"1.4\" fill=\"currentColor\" stroke=\"none\"/><circle cx=\"3.5\" cy=\"12\" r=\"1.4\" fill=\"currentColor\" stroke=\"none\"/><circle cx=\"3.5\" cy=\"18\" r=\"1.4\" fill=\"currentColor\" stroke=\"none\"/></svg> </div> <h3>高密度时间线</h3> <p>未读 / 全部 / 已读模式与长度排序，按分类、订阅源与静默订阅源筛选；macOS 原生分栏让列表与正文同步滚动。</p> </div> <div class=\"feature-card\"> <div class=\"feature-icon\"> <svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" aria-hidden=\"true\"><path d=\"M12 3l2.2 5.6L20 11l-5.8 2.4L12 19l-2.2-5.6L4 11l5.8-2.4z\"/><path d=\"M19 16.5l.9 2.1 2.1.9-2.1.9-.9 2.1-.9-2.1-2.1-.9 2.1-.9z\"/></svg> </div> <h3>AI 翻译与摘要</h3> <p>按订阅源自动翻译与生成摘要，保留 HTML 结构并支持原文 / 译文切换；模型、思考模式、temperature 与并发数独立配置，后台队列只服务仍未读的文章。</p> </div> <div class=\"feature-card\"> <div class=\"feature-icon\"> <svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" aria-hidden=\"true\"><path d=\"M12 3l7 3v5c0 4.5-3 8.2-7 10-4-1.8-7-5.5-7-10V6z\"/><path d=\"M9 12l2 2 4-4.5\"/></svg> </div> <h3>垃圾拦截审核</h3> <p>DeepSeek 逐篇给出保留 / 拒绝建议，被判定文章进入独立审核页：横滑、快捷键或右键菜单处理，最终决定由你做出。</p> </div> <div class=\"feature-card\"> <div class=\"feature-icon\"> <svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" aria-hidden=\"true\"><path d=\"M4 19.5A2.5 2.5 0 0 1 6.5 17H20\"/><path d=\"M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z\"/></svg> </div> <h3>长文与媒体阅读</h3> <p>HTML 拆块渲染、目录跳转、表格、代码块与 Markdown 复制；图片画廊与失败重试，普通视频、YouTube、Bilibili 内联播放并自动回退官方播放器。</p> </div> <div class=\"feature-card\"> <div class=\"feature-icon\"> <svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" aria-hidden=\"true\"><path d=\"M12 3l9 5-9 5-9-5z\"/><path d=\"M3 13l9 5 9-5\"/><path d=\"M3 17l9 5 9-5\"/></svg> </div> <h3>订阅源管理</h3> <p>Articles / Social Media / Inbox 分组与静默订阅源，可撤销的添加 / 编辑 / 取消订阅，跨客户端同步的共享目录。</p> </div> <div class=\"feature-card\"> <div class=\"feature-icon\"> <svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" aria-hidden=\"true\"><rect x=\"2\" y=\"4\" width=\"20\" height=\"13\" rx=\"2\"/><path d=\"M8 21h8M12 17v4\"/></svg> </div> <h3>桌面体验与隐私</h3> <p>macOS 原生分栏、克制的 Liquid Glass、右键菜单与快捷键；凭据本地保存，配置可导出为 JSON 通过剪贴板迁移，同步、AI 与后台任务全程可见。</p> </div> 工程 Wiki — 技术手册 这是一个“编辑 = 阅读”的单文件 HTML 知识库：每个专题页正文以 Markdown 内嵌在页面中， 克隆仓库后双击本页即可离线浏览全部专题，无需安"
 }
];
